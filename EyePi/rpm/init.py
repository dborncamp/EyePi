#!/usr/bin/python
#
# The init script for the EyePi service. Save to /etc/init.d
#
#
# chkconfig: - 20 70
# description: EyePi-X.X server process
#
#
### BEGIN INIT INFO
# Provides: EyePi-X.X
...
SERVICE = "EyePi-{0}.{1}".format(VERSION_MAJOR, VERSION_MINOR)
EXE = "/opt/services/{0}/bin/EyePi-bin".format(SERVICE)
