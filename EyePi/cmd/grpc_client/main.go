...
func run() int {
	...
	logger.Info().Str("grpc-client", "EyePi").
	...
	logger.Info().Str("grpc client", "EyePi").Msg("terminating normally")
	return 0
}
...
func newClient(
	...
	return pb.NewEyePiClient(conn), nil
}
